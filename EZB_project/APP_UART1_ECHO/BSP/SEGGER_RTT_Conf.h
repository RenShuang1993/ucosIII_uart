...
// has not been stored completely. Otherwise we would probably end up with 
// a mixed string in the buffer.
// If using  RTT from within interrupts, multiple tasks or multi 
// processors, define the SEGGER_RTT_LOCK() and SEGGER_RTT_UNLOCK() 
// function here.
//
...
//
// When defined as 1, the first call to an RTT function will modify the ID 
// of the RTT Callback Structure. To speed up identifying on the host,
