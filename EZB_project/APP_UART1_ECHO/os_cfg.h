 ...
 * @file os_cfg.h
 *
 * @brief OS Configuration - you'll need to adjust these constants for every
 *        project!
 */
#ifndef OS_CFG_H
#define OS_CFG_H
...
/* Include code for Task Local Storage (TLS) registers */
...
/******************************************************************* uC/TRACE */
/* Enable (1) or Disable (0) uC/Trace instrumentation */
